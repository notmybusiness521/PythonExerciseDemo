...
for i in range(9,10):
    imgfile="C:\\Users\\asus\\Desktop\\Desk\\mls\\{}.jpg".format(i)
    savefile = "C:\\Users\\asus\\Desktop\\Desk\\mls\\{}{}.jpg".format(i, "-1")
    a = np.asarray(Image.open(imgfile).convert('L')).astype('float')
    depath = 10 # (0-100)
